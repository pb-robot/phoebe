...
rostopic pub -1 /right_arm_shoulder_roll_joint/command std_msgs/Float64 -- 0 & # -1.5708
...
rostopic pub -1 /left_arm_shoulder_roll_joint/command std_msgs/Float64 -- 0 & # 1.5708
