...
if [ $# == 1 ]; then
  rostopic pub -1 /right_arm_shoulder_roll_joint/command std_msgs/Float64 -- -1.55 & # -1.5708
  ...
  rostopic pub -1 /left_arm_shoulder_roll_joint/command std_msgs/Float64 -- 1.63 & # 1.5708
  ...
  rostopic pub -1 /right_arm_shoulder_roll_joint/command std_msgs/Float64 -- -1.5708 &
  rostopic pub -1 /right_arm_shoulder_pitch_joint/command std_msgs/Float64 -- 1.5708 &
  ...
  rostopic pub -1 /left_arm_shoulder_roll_joint/command std_msgs/Float64 -- 1.5708 &
  rostopic pub -1 /left_arm_shoulder_pitch_joint/command std_msgs/Float64 -- 1.5708 &
